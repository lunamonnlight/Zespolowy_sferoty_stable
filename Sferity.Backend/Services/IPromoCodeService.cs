...
namespace Sferity.Backend.Services
{
    public interface IPromoCodeService
    {
        ...
        Task<PromoCodeDto?> RedeemAsync(PromoCodeIdentifierRequest request, int userId);         Task<IEnumerable<PromoCodeDto>> GetByIdentifierAsync(PromoCodeIdentifierRequest request);
