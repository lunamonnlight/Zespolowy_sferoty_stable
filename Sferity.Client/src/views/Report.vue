...
<template>
  <div class="flex h-screen flex-col bg-surface-900 text-surface-0 static z-40  ">
    ...
    border-r bg-surface-800 border-surface-700 transition-all duration-300 w-60 mt-4 mb-4 mt-2 p-2">
        <router-link
            to="/"
            class="flex items-center w-full rounded-lg transition-all duration-200 px-3 py-2.5 my-1 gap-3 
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="20" height="20" fill="currentColor"
               class="shrink-0">
            <path
                d="M168,112a56,56,0,1,1-56-56A56,56,0,0,1,168,112Zm61.66,117.66a8,8,0,0,1-11.32,0l-50.06-50.07a88,88,0,1,1,11.32-11.31l50.06,50.06A8,8,0,0,1,229.66,229.66ZM112,184a72,72,0,1,0-72-72A72.08,72.08,0,0,0,112,184Z"></path>
          </svg>
        ...
        <router-link
          ...
          cursor-pointer px-3 py-2.5 my-1 gap-3 bg-primary-500/15 text-primary-400"
        >
          ...
          <span class="text-sm font-medium">Raport</span>
        </router-link>
